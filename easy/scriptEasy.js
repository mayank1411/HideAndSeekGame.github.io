...
var chances = 0;
var numGift = 3;
// var dangerCard = document.getElementById(addDanger);
...
console.log(address);
var getCard = () => {
    var guessCell = document.getElementById("idGuess"); // C2
    console.log(guessCell);
    if(guessCell.value == addDanger){  // C2 == C2
    var dangerCard = document
    .getElementById(addDanger) // C2 cell 
    ...
    if(WON == false){
        ...
        document.getElementById("result").innerHTML = "YOU WON!!!!!!!";
         for(var j=1; j<=rating; j++){
            var s = document.getElementById(j).querySelector(".Star")
